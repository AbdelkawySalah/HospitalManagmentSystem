...
<div class="table-responsive">
    <table  id="example-delete" class="table text-md-nowrap" data-page-length="50" style="text-align: center">
        <thead>
        <tr>
            <th>#</th>
            <th>اسم الخدمة</th>
        ...
        @foreach ($single_invoices as $single_invoice)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_Invoices" wire:click="delete({{ $single_invoice->id }})"><i class="fa fa-trash"></i></button>
                </td>
            </tr>
